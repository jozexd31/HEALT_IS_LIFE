    ...
    return (
        ...
        <nav className='w-full py-1 shadow-md fixed'>
            ...
            <div className="-ml-4 -mt-2 flex flex-wrap items-center justify-between sm:flex-nowrap">
                ...
                {/* MENU DE LA CABECERA  */}
                    <NavLink className="text-lg inline-flex font-medium leading-6 text-gray-900 hover:underline hover:underline-offset-2 mx-4">PREDICCIONES</NavLink>
                    <NavLink className="text-lg inline-flex font-medium leading-6 text-gray-900 hover:underline hover:underline-offset-2 mx-4">BLOG</NavLink>
                    <NavLink className="text-lg inline-flex font-medium leading-6 text-gray-900 hover:underline hover:underline-offset-2 mx-4">HISTORIAL</NavLink>
                    <NavLink className="text-lg inline-flex font-medium leading-6 text-gray-900 hover:underline hover:underline-offset-2 mx-4">POR SI ACASO</NavLink>
