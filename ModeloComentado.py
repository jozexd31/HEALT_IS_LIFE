...
l1=['picazón','erupciones_cutáneas','erupciones_nodales_cutáneas','estornudos_continuos','temblores','escalofríos','dolor_articular','dolor_de_estómago','acidez','úlceras_en_la_lengua','desgaste_muscular','vómitos','ardor_micción','manchas_alorinar','fatiga',
